...
public class RecruiterController {
	...
	public void registerRecruiter(@RequestBody(required = true) Recruiter recruiter) throws MailException {
	...
	@ResponseBody
	public Recruiter recruiterLogin(@RequestBody Recruiter recruiter) {
		...
		return service.recruiterLogin(uname, password);
